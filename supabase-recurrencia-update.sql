-- =============================================
-- ACTUALIZACIÓN PARA INGRESOS RECURRENTES
-- =============================================
-- Archivo: supabase-recurrencia-update.sql
-- Descripción: Agregar campos para ingresos recurrentes
-- Fecha: Julio 2025
...
ALTER TABLE ingresos ADD COLUMN IF NOT EXISTS frecuencia VARCHAR(20) DEFAULT NULL; -- 'semanal', 'quincenal', 'mensual', 'bimestral', 'trimestral', 'semestral', 'anual', 'personalizada'
ALTER TABLE ingresos ADD COLUMN IF NOT EXISTS intervalo_dias INTEGER DEFAULT NULL; -- Para frecuencia personalizada
ALTER TABLE ingresos ADD COLUMN IF NOT EXISTS fecha_fin DATE DEFAULT NULL; -- Fecha límite para la recurrencia
...
COMMENT ON COLUMN ingresos.frecuencia IS 'Frecuencia de repetición: semanal, quincenal, mensual, etc.';
COMMENT ON COLUMN ingresos.intervalo_dias IS 'Número de días para frecuencia personalizada';
COMMENT ON COLUMN ingresos.fecha_fin IS 'Fecha límite hasta cuando se genera la recurrencia';
...
ALTER TABLE gastos ADD COLUMN IF NOT EXISTS frecuencia VARCHAR(20) DEFAULT NULL;
ALTER TABLE gastos ADD COLUMN IF NOT EXISTS intervalo_dias INTEGER DEFAULT NULL;
ALTER TABLE gastos ADD COLUMN IF NOT EXISTS fecha_fin DATE DEFAULT NULL;
